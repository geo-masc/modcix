...
#### 2.3 Joining Predictions and Reference
...
#### 3.1 Visualizing the Accuracy Assessment
...
regression_metrics <- valid_cuts %>% 
  ...
  summarise(mae=mean(abs(difference)),
...
regression_metrics %>% 
  ...
  theme_minimal() +
  theme(axis.title.x = element_text(size = 16L),
